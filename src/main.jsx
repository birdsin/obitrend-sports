...
function App(){
  ...
  return <div className="app">
    ...
    <main>
      ...
      {page==="Matches"&&<MatchesPage filtered={[...filtered,...upcoming.filter(u=>!matches.some(m=>m.id===u.id))]} query={query} setQuery={setQuery} setSelected={setSelected} leagueId={leagueId} setLeagueId={setLeagueId} season={season} setSeason={season} standings={standings} setStandings={setStandings} standingsLoading={standingsLoading} setStandingsLoading={setStandingsLoading} setProfile={setProfile}/>}
