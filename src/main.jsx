...
function App(){
  ...
  return <div className="app">
    ...
    <main>
      ...
      {page==="Matches"&&<MatchesPage filtered={filtered} query={query} setQuery={setQuery} setSelected={setSelected} leagueId={leagueId} setLeagueId={setLeagueId} season={season} setSeason={setSeason} standings={standings} setStandings={setStandings} standingsLoading={standingsLoading} setStandingsLoading={setStandingsLoading} setProfile={setProfile}/>}
